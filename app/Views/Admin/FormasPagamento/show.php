        ...
        <div class="card-body">
            ...
            <div class="mt-4">
                ...
                <?php if($forma->id != 1): ?>
                    ...
                    data-toggle="tooltip" data-placement="top" title="Editar forma de pagamento">
                    ...
                    <a href="<?php echo site_url("admin/formas/excluir/$forma->id"); ?>"
                        ...
                        data-toggle="tooltip" data-placement="top" title="Excluír forma de pagamento">
                ...
                <?php else:?>
                    ...
                    class="btn btn-dark btn-sm" data-toggle="tooltip" data-placement="top" title="Recuperar forma de pagamento">
