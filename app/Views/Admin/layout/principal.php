        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    ...
                    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/"
                            alt="Placeholder" /></a>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown mr-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                            ...
                            <p class="mb-0 font-weight-normal float-left dropdown-header">Placeholder</p>
                            <a class="dropdown-item">
                                <div class="item-thumbnail">
                                    <img src="images/" alt="Placeholder" class="profile-pic">
                                </div>
                                <div class="item-content flex-grow">
                                    <h6 class="ellipsis font-weight-normal">Placeholdern
                                    </h6>
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                            ...
                            <a class="dropdown-item">
                                ...
                                <div class="item-content">
                                    <h6 class="font-weight-normal">Placeholder</h6>
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="images/faces" alt="profilePic" />
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright ©
                            Food Delivery</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> VINÍCIUS ALMEIDA HERMES</span>
                    </div>
                </footer>
                <!-- partial -->
            </div>
